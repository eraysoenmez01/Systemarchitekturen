...
set CLASSPATH=%APP_HOME%\lib\smart-home-1.0-SNAPSHOT-all.jar

@rem Execute smart-home
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SMART_HOME_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%SMART_HOME_EXIT_CONSOLE%" exit 1
exit /b 1
